...
const SideNav = () => {
  ...
  return (
    <div className="flex flex-col float-left text-slate-50 gap-10 w-full mt-5">
      {/* <h1>SideVav Bar</h1> */}
      <a className="block text-teal-600 dark:text-teal-300 ml-16" href="#">
      ...
      {menuList.map((item, index) => (
        <button
          key={item.id}
          className={`flex items-center gap-4 p-4 px-2 hover:bg-gray-400 w-full text-slate-50 ${
